...
filename = 'C:/Users/ishwa/OneDrive/Desktop/movies-recommendation/nlp_model.pkl'
clf = pickle.load(open(filename, 'rb'))
vectorizer = pickle.load(open('C:/Users/ishwa/OneDrive/Desktop/movies-recommendation/tranform.pkl','rb'))
...
def get_suggestions():
    data = pd.read_csv('C:/Users/ishwa/OneDrive/Desktop/movies-recommendation/datasets/main_data.csv')
...
def recommend():
    ...
    # call the convert_to_list function for every string that
    ...
    #rendering the string yo python string
    ...
    if(imdb_id != ""):
        ...
        #web scraping to get user review from IMDB site
        sauce = urllib.request.urlopen('https://www.imdb.com/title/{}/reviews?ref_=tt_ov_rt'.format(imdb_id)).read()
        soup = bs.BeautifulSoup(sauce, 'lxml')
        soup_result = soup.find_all("div",{"class":"text show-more__control"})

        reviews_list =[] # list of review
        reviews_status =[]
        ...
        #pasing all the data to the html file
